                    ...
                    <Form className = 'formulario' onSubmit = {handleSubmit}>
                        <Row className="mb-5">
                            <Form.Group as={Col} controlId="formGridNombre" sm="4">
                                <FloatingLabel className="floatingInputGridJug" label="Nombre" style={{fontSize: "19px"}}>
                                    <Form.Control type="text" name="nombre"  placeholder="Nombre" style={{fontSize: "20px"}} value={data.nombre} readOnly/>
                                </FloatingLabel>
                            </Form.Group>

                            <Form.Group as={Col} controlId="formGridApellido" sm="4">
                                <FloatingLabel className="floatingInputGridJug" label="Apellido" style={{fontSize: "19px"}}>
                                    <Form.Control type="text" name="apellido" placeholder="Apellido" style={{fontSize: "20px"}} value={data.apellido} readOnly/>
                                </FloatingLabel>
                            </Form.Group>

                            <Form.Group as={Col} controlId="formGridFechaNac" sm="3" >
                                <FloatingLabel className="floatingInputGridJug" label="Fecha Nacimiento" style={{fontSize: "19px"}}>
                                    <Form.Control type="date" placeholder="Fecha Nacimiento" name="fechaNacimiento" style={{fontSize: "20px"}} value={data.fechaNacimiento} readOnly/>
                                </FloatingLabel>
                            </Form.Group>

                            <Form.Group as={Col} controlId="formGridCategoria" sm="1">
                                <FloatingLabel className="floatingInputGridJug" label="Categ." style={{fontSize: "19px"}}>
                        ...
                        <Row className="mb-5">
                            ...
                            <Form.Group as={Col} controlId="formGridTipoDocumento" sm="3">
                                <FloatingLabel className="floatingInputGridJug" label="Tipo documento" style={{fontSize: "19px"}}>
                                    <Form.Control type="text" name="tipodocumento" placeholder="Tipo documento" style={{fontSize: "20px"}} value= {data.tipoDocumento} readOnly/>
                                </FloatingLabel>
                            </Form.Group>
                            ...
                            <Form.Group as={Col} controlId="formGridNumeroDoc" sm="3">
                                <FloatingLabel className="floatingInputGridJug" label="Numero de documento" style={{fontSize: "19px"}}>
                                    <Form.Control type="text" name="nrodoc" placeholder="Numero de documento" style={{fontSize: "20px"}} value= {data.documento} readOnly/>
                                </FloatingLabel>
                            </Form.Group>

                            <Form.Group as={Col} controlId="formGridDireccion" sm="4">
                                <FloatingLabel className="floatingInputGridJug" label="Dirección" style={{fontSize: "19px"}}>
                                    <Form.Control type="text" placeholder="Dirección" name="direccion" style={{fontSize: "20px"}} value ={data.direccion} onChange={handleChange}/>
                                </FloatingLabel>
                            </Form.Group>

                            <Form.Group as={Col} controlId="formGridEstado" sm="2">
                                <FloatingLabel className="floatingInputGridJug" label="Estado" style={{fontSize: "19px"}}>
                                    <Form.Control type="text" name="estado" placeholder="Estado" style={{fontSize: "20px"}} value = {data.estado}readOnly/>
                                </FloatingLabel>
                            </Form.Group>
                        </Row>
                        ...
                        <Row className="mb-5">
                            ...
                            <Form.Group as={Col} controlId="formGridTelefono">
                                <FloatingLabel className="floatingInputGridJug" label="Numero de Telefono" style={{fontSize: "19px"}}>
                                    <Form.Control type="tel" placeholder="Numero de Telefono" name="telefono" style={{fontSize: "20px"}} value={data.telefono} onChange={handleChange}/>
                                </FloatingLabel>
                            </Form.Group>
                            
                            <Form.Group as={Col} controlId="formGridEmail">
                                <FloatingLabel className="floatingInputGridJug" label="Correo Electrónico" style={{fontSize: "19px"}}>
                                    <Form.Control type="email" placeholder="mail" name="mail" style={{fontSize: "20px"}} value={data.mail} onChange={handleChange}/>
                                </FloatingLabel>
                            </Form.Group>
