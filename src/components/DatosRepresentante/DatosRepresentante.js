                    ...
                    <Form>
                        <Row className="mb-3">
                            <Form.Group as={Col} md='4' controlId="formGridNombre">
                                ...
                                <Form.Control className = 'inputrep' type="text" placeholder="Nombre"/>
                            </Form.Group>

                            <Form.Group as={Col} md='4'controlId="formGridLegajo">
                                <Form.Label>Legajo</Form.Label>
                                <Form.Control className = 'inputrep' type="text" placeholder="Legajo" readOnly />
                            </Form.Group>

                            <Form.Group as ={Col} md='4' controlId="formGridDocumento">
                                <Form.Label>Documento</Form.Label>
                                <Form.Control className = 'inputrep' type= 'text' placeholder="Documento" readOnly/>
                            </Form.Group>
                        </Row>
                        ...
                        <Row className="mb-3 club">
                            <Form.Group as={Col} md = '5' className = 'club' controlId="formGridClub">
                                ...
                                <Form.Control className = 'inputrep' type="text" placeholder="Club" />
                            </Form.Group>   
                        </Row>
